  ...
  return function (e) {
    ...
    function n(e) {
      return e && e.__esModule ? e : { "default": e };
        ...
        f = o(24),
        v = n(f),
        p = new i["default"]();p.addPlugin(s["default"]), p.addPlugin(u["default"]), p.addPlugin(v["default"]), p.VConsolePlugin = c["default"], t["default"] = p, e.exports = t["default"];
  }, function (e, t, o) {
    "use strict";
    function n(e) {
      ...
      function e(e, t) {
        ...
        w = function () {
      function e() {
        i(this, e);var t = this;this.version = a["default"].version, this.html = p["default"], this.$dom = null, this.activedTab = "", this.tabList = [], this.pluginList = {}, this.console = {}, this.logList = [], this.isReady = !1, this.switchPos = { x: 10, y: 10, startX: 0, startY: 0, endX: 0, endY: 0 }, this.bodyOverflowCSS = "", this.tool = d, this.$ = f["default"];var o = function o() {
          t._render(), t._bindEvent(), t._autoRun();
        };"complete" == document.readyState ? o() : f["default"].bind(window, "load", o);
      }return l(e, [{ key: "_render", value: function value() {
          var e = "#__vconsole";if (!f["default"].one(e)) {
            var t = document.createElement("div");t.innerHTML = this.html, document.body.appendChild(t.children[0]);
          }this.$dom = f["default"].one(e);var o = d.getStorage("switch_x"),
              n = d.getStorage("switch_y");o && n && (this.switchPos.x = o, this.switchPos.y = n, f["default"].one(".vc-switch").style.right = o + "px", f["default"].one(".vc-switch").style.bottom = n + "px");
        } }, { key: "_bindEvent", value: function value() {
          var e = this,
              t = f["default"].one(".vc-switch", e.$dom);f["default"].bind(t, "touchstart", function (t) {
            e.switchPos.startX = t.touches[0].pageX, e.switchPos.startY = t.touches[0].pageY;
          }), f["default"].bind(t, "touchend", function (t) {
            0 == e.switchPos.endX && 0 == e.switchPos.endY || (e.switchPos.x = e.switchPos.endX, e.switchPos.y = e.switchPos.endY, e.switchPos.startX = 0, e.switchPos.startY = 0, e.switchPos.endX = 0, e.switchPos.endY = 0, d.setStorage("switch_x", e.switchPos.x), d.setStorage("switch_y", e.switchPos.y));
            ...
            if (o.touches.length > 0) {
              var n = o.touches[0].pageX - e.switchPos.startX,
                  ...
                  i = e.switchPos.x - n,
                  l = e.switchPos.y - r;0 > i && (i = 0), 0 > l && (l = 0), i + t.offsetWidth > document.body.offsetWidth && (i = document.body.offsetWidth - t.offsetWidth), l + t.offsetHeight > document.body.offsetHeight && (l = document.body.offsetHeight - t.offsetHeight), t.style.right = i + "px", t.style.bottom = l + "px", e.switchPos.endX = i, e.switchPos.endY = l, o.preventDefault();
            }
          ...
          var t = this;e.trigger("init"), e.trigger("renderTab", function (o) {
            t.tabList.push(e.id);var n = f["default"].render(g["default"], { id: e.id, name: e.name });f["default"].one(".vc-tabbar", t.$dom).appendChild(n);var r = f["default"].render(m["default"], { id: e.id });o && (d.isString(o) ? r.innerHTML += o : d.isFunction(o.appendTo) ? o.appendTo(r) : d.isElement(o) && r.appendChild(o)), f["default"].one(".vc-content", t.$dom).appendChild(r);
          }), e.trigger("addTool", function (t) {
            if (t) for (var o = f["default"].one(".vc-tool-last"), n = 0; n < t.length; n++) {
              var r = t[n],
                  i = f["default"].render(_["default"], { name: r.name || "Undefined", pluginID: e.id });1 == r.global && f["default"].addClass(i, "vc-global-tool"), d.isFunction(r.onClick) && f["default"].bind(i, "click", r.onClick), o.parentNode.insertBefore(i, o);
            }
          }), e.trigger("ready");
          ...
          return void 0 !== this.pluginList[e.id] ? (console.warn("Plugin " + e.id + " has already been added."), !1) : (this.pluginList[e.id] = e, this.isReady && this._initPlugin(e), !0);
        } }, { key: "show", value: function value() {
          f["default"].addClass(this.$dom, "vc-toggle"), this._triggerPluginsEvent("showConsole"), this.bodyOverflowCSS = document.body.style.overflow, document.body.style.overflow = "hidden";
        } }, { key: "hide", value: function value() {
          document.body.style.overflow = this.bodyOverflowCSS, f["default"].removeClass(this.$dom, "vc-toggle"), this._triggerPluginsEvent("hideConsole");
        } }, { key: "showTab", value: function value(e) {
          var t = f["default"].one("#__vc_log_" + e);f["default"].removeClass(f["default"].all(".vc-tab", this.$dom), "vc-actived"), f["default"].addClass(f["default"].one("#__vc_tab_" + e), "vc-actived"), f["default"].removeClass(f["default"].all(".vc-logbox", this.$dom), "vc-actived"), f["default"].addClass(t, "vc-actived"), f["default"].one(".vc-content", this.$dom).scrollTop = f["default"].one(".vc-content", this.$dom).scrollHeight, f["default"].removeClass(f["default"].all(".vc-tool", this.$dom), "vc-actived"), f["default"].addClass(f["default"].all(".vc-tool-" + e, this.$dom), "vc-actived"), this._triggerPluginEvent(this.activedTab, "hide"), this.activedTab = e, this._triggerPluginEvent(this.activedTab, "show");
        } }]), e;
    }();t["default"] = w, e.exports = t["default"];
  }, function (e, t) {
    e.exports = { name: "vconsole", version: "2.2.0", description: "A lightweight, extendable front-end developer tool for mobile web page.", homepage: "https://github.com/WechatFE/vConsole", main: "dist/vconsole.min.js", scripts: { test: "mocha", dist: "webpack && npm test" }, keywords: ["console", "debug", "mobile"], repository: { type: "git", url: "git+https://github.com/WechatFE/vConsole.git" }, dependencies: {}, devDependencies: { "babel-core": "^6.7.7", "babel-loader": "^6.2.4", "babel-plugin-add-module-exports": "^0.1.4", "babel-preset-es2015": "^6.6.0", "babel-preset-stage-3": "^6.5.0", chai: "^3.5.0", "css-loader": "^0.23.1", "extract-text-webpack-plugin": "^1.0.1", "html-loader": "^0.4.3", jsdom: "^9.2.1", "json-loader": "^0.5.4", less: "^2.5.3", "less-loader": "^2.2.3", mocha: "^2.5.3", "style-loader": "^0.13.1", webpack: "~1.12.11" }, author: "WechatFE Team", license: "MIT" };
  }, function (e, t) {
    "use strict";
    function o(e) {
      var t = e > 0 ? new Date(e) : new Date(),
          ...
          a = t.getMilliseconds() < 10 ? "0" + t.getMilliseconds() : t.getMilliseconds();return 100 > a && (a = "0" + a), { time: +t, year: r, month: n, day: o, hour: i, minute: l, second: c, millisecond: a };
    }function n(e) {
      ...
      function t(e) {
        ...
        if (d(e)) {
          if (t(e)) return void (f += "CircularObject");p.push({ parent: parent, child: e });var b = Object.keys(e);f += "{", v++;for (var g = 0; g < b.length; g++) {
            var h = b[g];e.hasOwnProperty(h) && (f += h + ": ", o(e[h], e), g < b.length - 1 && (f += ", "));
          }v--, f += "}", p.pop();
        } else if (i(e)) {
          if (t(e)) return void (f += "CircularArray");p.push({ parent: parent, child: e }), f += "[", v++;for (var m = 0; m < e.length; m++) {
            o(e[m], e), m < e.length - 1 && (f += ", ");
          }v--, f += "]", p.pop();
        } else f += r(e) ? '"' + e + '"' : n(e) ? e : l(e) ? e : a(e) ? "null" : c(e) ? "undefined" : u(e) ? "function()" : s(e) ? "symbol" : "unknown";
      }var f = "",
          v = 0,
          p = [];return o(e, null), f;
    }function b(e, t) {
    ...
    }Object.defineProperty(t, "__esModule", { value: !0 });var h = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
      return typeof e === "undefined" ? "undefined" : _typeof(e);
    } : function (e) {
      return e && "function" == typeof Symbol && e.constructor === Symbol ? "symbol" : typeof e === "undefined" ? "undefined" : _typeof(e);
    };t.getDate = o, t.isNumber = n, t.isString = r, t.isArray = i, t.isBoolean = l, t.isUndefined = c, t.isNull = a, t.isSymbol = s, t.isObject = d, t.isFunction = u, t.isElement = f, t.htmlEncode = v, t.JSONStringify = p, t.setStorage = b, t.getStorage = g;
  }, function (e, t, o) {
    "use strict";
    function n(e) {
      return e && e.__esModule ? e : { "default": e };
      ...
      if (e) {
        (0, r.isArray)(e) || (e = [e]);for (var o = 0; o < e.length; o++) {
          e[o].className += " " + t;
        }
      }
      ...
      if (e) {
        void 0 === n && (n = !1), (0, r.isArray)(e) || (e = [e]);for (var i = 0; i < e.length; i++) {
          e[i].addEventListener(t, o, n);
        }
      }
    }, c.delegate = function (e, t, o, n) {
      e && e.addEventListener(t, function (t) {
        var r = c.all(o, e);if (r) e: for (var i = 0; i < r.length; i++) {
    ...
    }, c.render = l["default"], t["default"] = c, e.exports = t["default"];
  }, function (e, t) {
    "use strict";
    function o(e, t, o) {
      var n = /\{\{([^\}]+)\}\}/g,
      ...
      }c(e.substr(i, e.length - i), !1), r += 'return arr.join("");', r = "with (this) {\n" + r + "\n}";var a = new Function(r).apply(t);if (!o) {
        var s = document.createElement("div");s.innerHTML = a, a = s.children[0];
      }return a;
    ...
    e.exports = function () {
      var e = [];return e.toString = function () {
        ...
        "string" == typeof t && (t = [[null, t, ""]]);for (var n = {}, r = 0; r < this.length; r++) {
          ...
          var l = t[r];"number" == typeof l[0] && n[l[0]] || (o && !l[2] ? l[2] = o : o && (l[2] = "(" + l[2] + ") and (" + o + ")"), e.push(l));
        }
      }, e;
    };
  }, function (e, t, o) {
    function n(e, t) {
      ...
      for (var t = [], o = {}, n = 0; n < e.length; n++) {
        var r = e[n],
            ...
            c = r[2],
            a = r[3],
            s = { css: l, media: c, sourceMap: a };o[i] ? o[i].parts.push(s) : t.push(o[i] = { id: i, parts: [s] });
      }return t;
    }function i(e, t) {
      var o = g(),
      ...
      var o, n, r;if (t.singleton) {
        var i = m++;o = h || (h = c(t)), n = d.bind(null, o, i, !1), r = d.bind(null, o, i, !0);
      } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (o = a(t), n = f.bind(null, o), r = function r() {
        l(o), o.href && URL.revokeObjectURL(o.href);
      }) : (o = c(t), n = u.bind(null, o), r = function r() {
        l(o);
      ...
      var r = o ? "" : n.css;if (e.styleSheet) e.styleSheet.cssText = _(t, r);else {
        var i = document.createTextNode(r),
            l = e.childNodes;l[t] && e.removeChild(l[t]), l.length ? e.insertBefore(i, l[t]) : e.appendChild(i);
      }
    }function u(e, t) {
      var o = t.css,
      ...
      t = t || {}, "undefined" == typeof t.singleton && (t.singleton = b()), "undefined" == typeof t.insertAt && (t.insertAt = "bottom");var o = r(e);return n(o, t), function (e) {
        for (var i = [], l = 0; l < o.length; l++) {
          var c = o[l],
              a = v[c.id];a.refs--, i.push(a);
        }if (e) {
          var s = r(e);n(s, t);
        }for (var l = 0; l < i.length; l++) {
          var a = i[l];if (0 === a.refs) {
    ...
    e.exports = '<div id=__vconsole class=""> <div class=vc-switch>vConsole</div> <div class=vc-mask> </div> <div class=vc-panel> <div class=vc-tabbar> </div> <div class=vc-content> </div> <div class=vc-toolbar> <a class="vc-tool vc-global-tool vc-tool-last vc-hide">Hide</a> </div> </div> </div>';
  }, function (e, t) {
    ...
    function _interopRequireWildcard(e) {
      ...
      null === t && (t = Function.prototype);var r = Object.getOwnPropertyDescriptor(t, o);if (void 0 === r) {
        var i = Object.getPrototypeOf(t);return null === i ? void 0 : e(i, o, n);
      }if ("value" in r) return r.value;var l = r.get;if (void 0 !== l) return l.call(n);
    },
      ...
      function VConsoleDefaultTab() {
        var e;_classCallCheck(this, VConsoleDefaultTab);for (var t = arguments.length, o = Array(t), n = 0; t > n; n++) {
          o[n] = arguments[n];
        }var r = _possibleConstructorReturn(this, (e = Object.getPrototypeOf(VConsoleDefaultTab)).call.apply(e, [this].concat(o)));return r.tplTabbox = _tabbox_default2["default"], r.windowOnError = null, r;
          ...
          _get(Object.getPrototypeOf(VConsoleDefaultTab.prototype), "mockConsole", this).call(this);var e = this;tool.isFunction(window.onerror) && (this.windowOnError = window.onerror), window.onerror = function (t, o, n, r, i) {
            var l = t;o && (l += "\n" + o.replace(location.origin, "")), (n || r) && (l += ":" + n + ":" + r), e.printLog({ logType: "error", logs: [l], noOrigin: !0 }), tool.isFunction(e.windowOnError) && e.windowOnError.apply(window, t, o, n, r, i);
          };
        } }, { key: "evalCommand", value: function evalCommand(cmd) {
          var date = tool.getDate(+new Date());this.renderLog({ logType: "log", meta: date.hour + ":" + date.minute + ":" + date.second, content: _query2["default"].render(_item_code2["default"], { content: cmd, type: "input" }, !0), style: "" });var result = eval(cmd),
              content = "";content = tool.isArray(result) || tool.isObject(result) ? this.getFoldedLine(result) : _query2["default"].render(_item_code2["default"], { content: result, type: "output" }, !0), this.renderLog({ logType: "log", meta: "", content: content, style: "vc-item-nometa" });
        } }]), VConsoleDefaultTab;
    }(_log2["default"]),
        tab = new VConsoleDefaultTab("default", "Log");exports["default"] = tab, module.exports = exports["default"];
  }, function (e, t, o) {
    "use strict";
    function n(e) {
      return e && e.__esModule ? e : { "default": e };
      ...
      function e(e, t) {
        ...
        x = function (e) {
      function t() {
        var e;i(this, t);for (var o = arguments.length, n = Array(o), r = 0; o > r; r++) {
          n[r] = arguments[r];
        }var c = l(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));return c.tplTabbox = "", c.allowUnformattedLog = !0, c.isReady = !1, c.$tabbox = null, c.console = {}, c.logList = [], c.mockConsole(), c;
      }return c(t, e), s(t, [{ key: "onInit", value: function value() {
          this.isReady = !0, this.$tabbox = v["default"].render(this.tplTabbox, {});for (var e = 0; e < this.logList.length; e++) {
          ...
          v["default"].bind(v["default"].one(".vc-log", this.$tabbox), "click", function (e) {
            var t = e.target;v["default"].hasClass(t, "vc-fold-outer") && (v["default"].hasClass(t.parentElement, "vc-toggle") ? v["default"].removeClass(t.parentElement, "vc-toggle") : v["default"].addClass(t.parentElement, "vc-toggle"), e.preventDefault());
          });
        } }, { key: "mockConsole", value: function value() {
          ...
          var t = e.logs;if (t.length) {
            t = [].slice.call(t);var o = !0,
                n = /^\[(\w+)\] ?/i,
                r = "";if (u.isString(t[0])) {
              var i = t[0].match(n);null !== i && i.length > 0 && (r = i[1].toLowerCase());
            }if (r ? o = r == this.id : 0 == this.allowUnformattedLog && (o = !1), !o) return void (e.noOrigin || this.printOriginLog(e));if (e.date || (e.date = +new Date()), !this.isReady) return void this.logList.push(e);u.isString(t[0]) && (t[0] = t[0].replace(n, ""), "" === t[0] && t.shift());for (var l = "", c = 0; c < t.length; c++) {
              try {
                if ("" === t[c]) continue;l += u.isFunction(t[c]) ? " " + t[c].toString() : u.isObject(t[c]) || u.isArray(t[c]) ? " " + this.getFoldedLine(t[c]) : " " + u.htmlEncode(t[c]).replace(/\n/g, "<br/>");
              } catch (s) {
                l += " [" + a(t[c]) + "]";
              }
            }var d = u.getDate(e.date);this.renderLog({ logType: e.logType, content: l, meta: d.hour + ":" + d.minute + ":" + d.second, style: "" }), e.noOrigin || this.printOriginLog(e);
          }
        } }, { key: "renderLog", value: function value(e) {
          var t = v["default"].render(h["default"], e);v["default"].one(".vc-log", this.$tabbox).appendChild(t), v["default"].one(".vc-content").scrollTop = v["default"].one(".vc-content").scrollHeight;
        } }, { key: "getFoldedLine", value: function value(e) {
          function t(e) {
            ...
            if (u.isObject(e)) {
              if (t(e)) return void (i += "{Circular Object}");s.push({ parent: n, child: e });var r = Object.keys(e);i += "{\n", c++;for (var l = 0; l < r.length; l++) {
                var d = r[l];e.hasOwnProperty(d) && (i += Array(c + 1).join(a) + v["default"].render(w["default"], { type: "key", code: d }, !0) + ": ", o(e[d], e), l < r.length - 1 && (i += ",\n"));
              }c--, i += "\n" + Array(c + 1).join(a) + "}", s.pop();
            } else if (u.isArray(e)) {
              if (t(e)) return void (i += "[Circular Array]");s.push({ parent: n, child: e }), i += "[\n", c++;for (var f = 0; f < e.length; f++) {
                i += Array(c + 1).join(a) + v["default"].render(w["default"], { type: "key", code: f }, !0) + ": ", o(e[f], e), f < e.length - 1 && (i += ",\n");
              }c--, i += "\n" + Array(c + 1).join(a) + "]", s.pop();
            } else i += u.isString(e) ? v["default"].render(w["default"], { type: "string", code: '"' + u.htmlEncode(e) + '"' }, !0) : u.isNumber(e) ? v["default"].render(w["default"], { type: "number", code: e }, !0) : u.isBoolean(e) ? v["default"].render(w["default"], { type: "boolean", code: e }, !0) : u.isNull(e) ? v["default"].render(w["default"], { type: "null", code: "null" }, !0) : u.isUndefined(e) ? v["default"].render(w["default"], { type: "undefined", code: "undefined" }, !0) : u.isFunction(e) ? v["default"].render(w["default"], { type: "function", code: "function()" }, !0) : JSON.stringify(e);
          }var n = u.JSONStringify(e),
              r = "",
              i = "",
              l = "",
              c = 0,
              a = "  ";l = n.substr(0, 26), n.length > 26 && (l += "..."), r = Object.prototype.toString.call(e).replace("[object ", "").replace("]", ""), r += " " + l;var s = [];o(e, null);var d = v["default"].render(y["default"], { outer: r, inner: i }, !0);return d;
        } }]), t;
    ...
    function n(e) {
      ...
      null === e && (e = Function.prototype);var n = Object.getOwnPropertyDescriptor(e, t);if (void 0 === n) {
        var r = Object.getPrototypeOf(e);return null === r ? void 0 : m(r, t, o);
      ...
      function t() {
        var e;i(this, t);for (var o = arguments.length, n = Array(o), r = 0; o > r; r++) {
          n[r] = arguments[r];
        }var c = l(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));return c.tplTabbox = b["default"], c.allowUnformattedLog = !1, c;
      }return c(t, e), a(t, [{ key: "onInit", value: function value() {
          ...
          var e = navigator.userAgent,
              t = "",
              o = u.getDate();console.info("[system]", "Now:", o.year + "-" + o.month + "-" + o.day + " " + o.hour + ":" + o.minute + ":" + o.second + "." + o.millisecond), t = "Unknown";var n = e.match(/(ipod).*\s([\d_]+)/i),
              r = e.match(/(ipad).*\s([\d_]+)/i),
              i = e.match(/(iphone)\sos\s([\d_]+)/i),
              l = e.match(/(android)\s([\d\.]+)/i);l ? t = "Android " + l[2] : i ? t = "iPhone, iOS " + i[2].replace(/_/g, ".") : r ? t = "iPad, iOS " + r[2].replace(/_/g, ".") : n && (t = "iPod, iOS " + n[2].replace(/_/g, ".")), console.info("[system]", "System:", t);var c = e.match(/MicroMessenger\/([\d\.]+)/i);t = "Unknown", c && c[1] && (t = c[1], console.info("[system]", "WeChat:", t));var a = e.toLowerCase().match(/ nettype\/([^ ]+)/g);t = "Unknown", a && a[0] && (a = a[0].split("/"), t = a[1], console.info("[system]", "Network:", t)), t = "Unknown", t = "https:" == location.protocol ? "HTTPS" : "http:" == location.protocol ? "HTTP" : location.protocol.replace(":", ""), console.info("[system]", "Protocol:", t);var s = window.performance || window.msPerformance || window.webkitPerformance;if (s && s.timing) {
            var d = s.timing,
                f = d.navigationStart;console.info("[system]", "connectEndTime:", d.connectEnd - f + "ms"), console.info("[system]", "responseEndTime:", d.responseEnd - f + "ms"), d.secureConnectionStart > 0 && console.info("[system]", "SSL Cost:", d.connectEnd - d.secureConnectionStart + "ms"), console.info("[system]", "DomRenderCost:", d.domComplete - d.domLoading + "ms");
          }console.info("[system]", "UA:", e);
        } }]), t;
    }(v["default"]),
        h = new g("system", "System");t["default"] = h, e.exports = t["default"];
  }, function (e, t) {
    ...
    function n(e) {
      ...
      function t() {
        var e;i(this, t);for (var o = arguments.length, n = Array(o), r = 0; o > r; r++) {
          n[r] = arguments[r];
        }var c = l(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));return c.$tabbox = d["default"].render(g["default"], {}), c.$header = null, c.reqList = {}, c.domList = {}, c.mockAjax(), c;
      }return c(t, e), a(t, [{ key: "onRenderTab", value: function value(e) {
          e(this.$tabbox);
        } }, { key: "onAddTool", value: function value(e) {
          var t = this,
              o = [{ name: "Clear", global: !1, onClick: function onClick(e) {
          ...
          this.renderHeader(), d["default"].delegate(d["default"].one(".vc-log", this.$tabbox), "click", ".vc-group-preview", function (e) {
          ...
          var o = Object.keys(this.reqList).length,
              n = this.reqList[e] || {};for (var r in t) {
            n[r] = t[r];
          }this.reqList[e] = n;var i = { url: n.url, status: n.status || "-", type: "-", costTime: n.costTime > 0 ? n.costTime + "ms" : "-", header: n.header, response: f.htmlEncode(n.response) };n.readyState <= 1 ? i.status = "Pending" : n.readyState < 4 && (i.status = "Loading");var l = d["default"].render(_["default"], i),
              c = this.domList[e];n.status >= 400 && d["default"].addClass(d["default"].one(".vc-group-preview", l), "vc-table-row-error"), c ? c.parentNode.replaceChild(l, c) : d["default"].one(".vc-log", this.$tabbox).appendChild(l), this.domList[e] = l;var a = Object.keys(this.reqList).length;a != o && this.renderHeader();
        } }, { key: "mockAjax", value: function value() {
          var e = window.XMLHttpRequest;if (e) {
            var t = this,
                o = window.XMLHttpRequest.prototype.open;window.XMLHttpRequest.prototype.send;window.XMLHttpRequest.prototype.open = function () {
              var e = this,
                  n = [].slice.call(arguments),
                  r = n[1],
                  i = t.getUniqueID();e._requestID = i;var l = e.onreadystatechange || function () {};return e.onreadystatechange = function () {
                var o = t.reqList[i] || {};if (o.url = r, o.readyState = e.readyState, 0 == e.readyState) o.startTime = +new Date();else if (1 == e.readyState) o.startTime = +new Date();else if (2 == e.readyState) {
                  o.header = {};for (var n = e.getAllResponseHeaders() || "", c = n.split("\n"), a = 0; a < c.length; a++) {
                    var s = c[a];if (s) {
                      var d = s.split(": "),
                          u = d[0],
                          f = d.slice(1).join(": ");o.header[u] = f;
                    }
                  }
                } else 3 == e.readyState || 4 == e.readyState && (o.status = e.status, o.endTime = +new Date(), o.costTime = o.endTime - (o.startTime || o.endTime), o.response = e.response);return e._noVConsole || t.updateRequest(i, o), l.apply(e, arguments);
              }, o.apply(e, n);
            };
          }
        ...
        x = new w("network", "Network");t["default"] = x, e.exports = t["default"];
  }, function (e, t) {
